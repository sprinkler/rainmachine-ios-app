//
//  SprinklerListViewController_iPad.m
//  Sprinklers
//
...
@implementation SprinklerListViewController_iPad
...
- (void)shouldStopBroadcast {
    ...
    if (discoveredSprinklers && discoveredSprinklers.count > 1) {
        [_tableView reloadData];
    } else if (discoveredSprinklers && discoveredSprinklers.count == 1) {
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    if (buttonIndex == 1) {
        SprinklerStaticListViewController *staticList = [[SprinklerStaticListViewController alloc] init];

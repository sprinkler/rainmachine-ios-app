//
//  SprinklerStaticListViewController.m
//  Sprinklers
//
...
#import "SprinklerStaticListViewController.h"
#import "StorageManager.h"
#import "WebPageViewController.h"
#import "AddSprinklerViewController_iPad.h"

@implementation SprinklerStaticListViewController
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (_shouldDisplayAdd) {
        ...
        AddSprinklerViewController_iPad *addSprinkler = [[AddSprinklerViewController_iPad alloc] init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_tableView.isEditing && indexPath.section == 1 && indexPath.row < savedSprinklers.count) {
        AddSprinklerViewController_iPad *addSprinkler = [[AddSprinklerViewController_iPad alloc] init];

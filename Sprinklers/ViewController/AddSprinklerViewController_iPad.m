//
//  AddSprinklerViewController_iPad.m
//  Sprinklers
//
...
@implementation AddSprinklerViewController_iPad
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITextField *text = [[UITextField alloc] initWithFrame:CGRectMake(5, 10, _tableView.width - 200, 30)];

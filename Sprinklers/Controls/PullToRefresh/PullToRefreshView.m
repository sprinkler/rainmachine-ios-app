...
#define BACKGROUND_COLOR [UIColor colorWithRed:232.0f / 255.0f green:232.0f / 255.0f blue:232.0f / 255.0f alpha:1.0f]
...
- (id)initWithScrollView:(UIScrollView *)scroll {
    ...
    //CGRect frame = CGRectMake(0.0f, -50.0f, scroll.bounds.size.width, scroll.bounds.size.height);
...
- (void)setState:(PullToRefreshViewState)state_ {
    ...
    switch (state) {
        case PullToRefreshViewStateReady:
            statusLabel.text = @"Release to refresh sprinkler list...";
        ...
        case PullToRefreshViewStateNormal:
            statusLabel.text = @"Pull down to refresh sprinkler list...";
            [self showActivity:NO animated:NO];
        ...
        case PullToRefreshViewStateLoading:
            statusLabel.text = @"Refreshing sprinkler list...";
